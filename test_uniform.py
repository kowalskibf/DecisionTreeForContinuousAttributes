...
from DecisionTreeUniform import DecisionTreeUniform
...
def main(file_name, separator, id):
    ...
    dt = DecisionTreeUniform(attributes, training_data)
    dt.build_tree()
    ...
    file_path = f'U_1_wynik_{file_name}_{id}_{datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}.txt'
